...
Make sure to run ingest.py first to build the vectorstore.
"""
...
.chat-bubble-user {
    ...
    padding: 14px 18px; margin: 8px 0; color: #e2e8f0; font-size: 0.95em;
}
.chat-bubble-bot {
    background: #131929; border: 1px solid #1e3a5f;
...
.source-card {
    ...
    font-size: 0.82em; color: #94a3b8; font-family: 'DM Mono', monospace;
}
...
.sidebar-section h4 {
    color: #a78bfa; font-size: 0.8em; text-transform: uppercase;
...
for key, val in {
    ...
    "session_id": "user_01", "session_store": {},
    "total_queries": 0, "avg_latency": 0.0
}.items():
...
def load_rag_pipeline():
    ...
    # ── Local embeddings — same model as ingest.py
...
with st.sidebar:
    ...
    st.markdown(
        ...
        f"Embed: <b style='color:#a78bfa;'>BGE-large-en-v1.5</b>"
        f"</p></div>", unsafe_allow_html=True
    )
...
<div class="main-header">
  <h1>⚖️ LexAssist</h1>
  <p>Indian Legal & Government Schemes Navigator · llama-3.1-70b · BGE Embeddings · RAG</p>
</div>
""", unsafe_allow_html=True)
